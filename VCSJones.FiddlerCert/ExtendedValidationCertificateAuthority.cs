...
namespace VCSJones.FiddlerCert
{
    internal class CertificateValidatedChecker
    {
        ...
        public static ExtendedValidationMetadata[] EVRootCAMetadata { get; } = new[]
        {
             ...
             Sha256Fingerprint = new byte[] {0x06, 0x3e, 0x4a, 0xfa, 0xc4, 0x91, 0xdf, 0xd3, 0x32, 0xf3, 0x08,
              ...
              PolicyOids = new string [] {
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x13, 0x63, 0x35, 0x43, 0x93, 0x34, 0xa7, 0x69, 0x80, 0x16, 0xa0,
              ...
              PolicyOids = new string [] {
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x68, 0x7f, 0xa4, 0x51, 0x38, 0x22, 0x78, 0xff, 0xf0, 0xc8, 0xb1,
              ...
              PolicyOids = new string [] {
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x55, 0x92, 0x60, 0x84, 0xec, 0x96, 0x3a, 0x64, 0xb9, 0x6e, 0x2a,
              ...
              PolicyOids = new string [] {"1.3.159.1.17.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x03, 0x76, 0xab, 0x1d, 0x54, 0xc5, 0xf9, 0x80, 0x3c, 0xe4, 0xb2,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.34697.2.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x0a, 0x81, 0xec, 0x5a, 0x92, 0x97, 0x77, 0xf1, 0x45, 0x90, 0x4a,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.34697.2.2", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x70, 0xa7, 0x3f, 0x7f, 0x37, 0x6b, 0x60, 0x07, 0x42, 0x48, 0x90,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.34697.2.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xbd, 0x71, 0xfd, 0xf6, 0xda, 0x97, 0xe4, 0xcf, 0x62, 0xd1, 0x64,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.34697.2.4", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x8e, 0xcd, 0xe6, 0x88, 0x4f, 0x3d, 0x87, 0xb1, 0x12, 0x5b, 0xa3,
                      0x1a, 0xc3, 0xfc, 0xb1, 0x3d, 0x70, 0x16, 0xde, 0x7f, 0x57, 0xcc,
                      0x90, 0x4f, 0xe1, 0xcb, 0x97, 0xc6, 0xae, 0x98, 0x19, 0x6e},
              PolicyOids = new string [] {"2.23.140.1.1", ""}
            },
                // Amazon Root CA 2
                // https://good.sca2a.amazontrust.com/
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x1b, 0xa5, 0xb2, 0xaa, 0x8c, 0x65, 0x40, 0x1a, 0x82, 0x96, 0x01,
              ...
              PolicyOids = new string [] {"2.23.140.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x18, 0xce, 0x6c, 0xfe, 0x7b, 0xf1, 0x4e, 0x60, 0xb2, 0xe3, 0x47,
              ...
              PolicyOids = new string [] {"2.23.140.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xe3, 0x5d, 0x28, 0x41, 0x9e, 0xd0, 0x20, 0x25, 0xcf, 0xa6, 0x90,
              ...
              PolicyOids = new string [] {"2.23.140.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x04, 0x04, 0x80, 0x28, 0xbf, 0x1f, 0x28, 0x64, 0xd4, 0x8f, 0x9a,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.13177.10.1.3.10", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x16, 0xaf, 0x57, 0xa9, 0xf6, 0x76, 0xb0, 0xab, 0x12, 0x60, 0x95,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6334.1.100.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xb7, 0xb1, 0x2b, 0x17, 0x1f, 0x82, 0x1d, 0xaa, 0x99, 0x0c, 0xd0,
              ...
              PolicyOids = new string [] {"2.16.578.1.26.1.3.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xed, 0xf7, 0xeb, 0xbc, 0xa2, 0x7a, 0x2a, 0x38, 0x4d, 0x38, 0x7b,
              ...
              PolicyOids = new string [] {"2.16.578.1.26.1.3.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x0f, 0x99, 0x3c, 0x8a, 0xef, 0x97, 0xba, 0xaf, 0x56, 0x87, 0x14,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.22234.2.5.2.3.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x5c, 0x58, 0x46, 0x8d, 0x55, 0xf5, 0x8e, 0x49, 0x7e, 0x74, 0x39,
              ...
              PolicyOids = new string [] {"1.2.616.1.113527.2.5.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x5c, 0xc3, 0xd7, 0x8e, 0x4e, 0x1d, 0x5e, 0x45, 0x54, 0x7a, 0x04,
                      0xe6, 0x87, 0x3e, 0x64, 0xf9, 0x0c, 0xf9, 0x53, 0x6d, 0x1c, 0xcc,
                      0x2e, 0xf8, 0x00, 0xf3, 0x55, 0xc4, 0xc5, 0xfd, 0x70, 0xfd},
              PolicyOids = new string [] {"2.16.156.112554.3", ""}
            },
                // China Internet Network Information Center EV Certificates Root
                // https://evdemo.cnnic.cn/
                 new ExtendedValidationMetadata {
                    // Root
                    Sha256Fingerprint = new byte[] {0x1c, 0x01, 0xc6, 0xf4, 0xdb, 0xb2, 0xfe, 0xfc, 0x22, 0x55, 0x8b,
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x0c, 0x2c, 0xd6, 0x3d, 0xf7, 0x80, 0x6f, 0xa3, 0x99, 0xed, 0xe8,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6449.1.2.1.5.1", ""}
                ...
                // https://secure.comodo.com/
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x1a, 0x0d, 0x20, 0x44, 0x5d, 0xe5, 0xba, 0x18, 0x62, 0xd1, 0x9e,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6449.1.2.1.5.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x17, 0x93, 0x92, 0x7a, 0x06, 0x14, 0x54, 0x97, 0x89, 0xad, 0xce,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6449.1.2.1.5.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x52, 0xf0, 0xe1, 0xc4, 0xe5, 0x8e, 0xc6, 0x29, 0x29, 0x1b, 0x60,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6449.1.2.1.5.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x96, 0x0a, 0xdf, 0x00, 0x63, 0xe9, 0x63, 0x56, 0x75, 0x0c, 0x29,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6334.1.100.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x74, 0x31, 0xe5, 0xf4, 0xc3, 0xc1, 0xce, 0x46, 0x90, 0x77, 0x4f,
              ...
              PolicyOids = new string [] {"2.16.840.1.114412.2.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xee, 0xc5, 0x49, 0x6b, 0x98, 0x8c, 0xe9, 0x86, 0x25, 0xb9, 0x34,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.4788.2.202.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x62, 0xf2, 0x40, 0x27, 0x8c, 0x56, 0x4c, 0x4d, 0xd8, 0xbf, 0x7d,
              ...
              PolicyOids = new string [] {"2.16.840.1.114028.10.1.2", ""}
                ...
                // https://www.entrust.net/
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x73, 0xc1, 0x76, 0x43, 0x4f, 0x1b, 0xc6, 0xd5, 0xad, 0xf4, 0x5b,
              ...
              PolicyOids = new string [] {"2.16.840.1.114028.10.1.2", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x43, 0xdf, 0x57, 0x74, 0xb0, 0x3e, 0x7f, 0xef, 0x5f, 0xe4, 0x0d,
              ...
              PolicyOids = new string [] {"2.16.840.1.114028.10.1.2", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x02, 0xed, 0x0e, 0xb2, 0x8c, 0x14, 0xda, 0x45, 0x16, 0x5c, 0x56,
              ...
              PolicyOids = new string [] {"2.16.840.1.114028.10.1.2", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x08, 0x29, 0x7a, 0x40, 0x47, 0xdb, 0xa2, 0x36, 0x80, 0xc7, 0x31,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.14370.1.6", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xb0, 0xbf, 0xd5, 0x2b, 0xb0, 0xd7, 0xd9, 0xbd, 0x92, 0xbf, 0x5d,
              ...
              PolicyOids = new string [] {"2.16.792.3.0.4.1.1.4", ""}
                ...
                // https://www.geotrust.com/
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x37, 0xd5, 0x10, 0x06, 0xc5, 0x12, 0xea, 0xab, 0x62, 0x64, 0x21,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.14370.1.6", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x5e, 0xdb, 0x7a, 0xc4, 0x3b, 0x82, 0xa0, 0x6a, 0x87, 0x61, 0xe8,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.14370.1.6", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xb4, 0x78, 0xb8, 0x12, 0x25, 0x0d, 0xf8, 0x78, 0x63, 0x5c, 0x2a,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.14370.1.6", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xca, 0x42, 0xdd, 0x41, 0x74, 0x5f, 0xd0, 0xb8, 0x1e, 0xb9, 0x02,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.4146.1.1", ""}
                ...
                // GlobalSign Root CA
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xeb, 0xd4, 0x10, 0x40, 0xe4, 0xbb, 0x3e, 0xc7, 0x42, 0xc9, 0xe3,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.4146.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xcb, 0xb5, 0x22, 0xd7, 0xb7, 0xf1, 0x27, 0xad, 0x6a, 0x01, 0x13,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.4146.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xbe, 0xc9, 0x49, 0x11, 0xc2, 0x95, 0x56, 0x76, 0xdb, 0x6c, 0x0a,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.4146.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x17, 0x9f, 0xbc, 0x14, 0x8a, 0x3d, 0xd0, 0x0f, 0xd2, 0x4e, 0xa1,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.4146.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xc3, 0x84, 0x6b, 0xf2, 0x4b, 0x9e, 0x93, 0xca, 0x64, 0x27, 0x4c,
              ...
              PolicyOids = new string [] {"2.16.840.1.114413.1.7.23.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x45, 0x14, 0x0b, 0x32, 0x47, 0xeb, 0x9c, 0xc8, 0xc5, 0xb4, 0xf0,
              ...
              PolicyOids = new string [] {"2.16.840.1.114413.1.7.23.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xa5, 0x31, 0x25, 0x18, 0x8d, 0x21, 0x10, 0xaa, 0x96, 0x4b, 0x02,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6334.1.100.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x25, 0x30, 0xcc, 0x8e, 0x98, 0x32, 0x15, 0x02, 0xba, 0xd9, 0x6f,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.14777.6.1.1", "1.3.6.1.4.1.14777.6.1.2"}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x23, 0x80, 0x42, 0x03, 0xca, 0x45, 0xd8, 0xcd, 0xe7, 0x16, 0xb8,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.14777.6.1.1", "1.3.6.1.4.1.14777.6.1.2"}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x54, 0x45, 0x5f, 0x71, 0x29, 0xc2, 0x0b, 0x14, 0x47, 0xc4, 0x18,
                      0xf9, 0x97, 0x16, 0x8f, 0x24, 0xc5, 0x8f, 0xc5, 0x02, 0x3b, 0xf5,
                      0xda, 0x5b, 0xe2, 0xeb, 0x6e, 0x1d, 0xd8, 0x90, 0x2e, 0xd5},
              PolicyOids = new string [] {"1.3.171.1.1.10.5.2", ""}
            },
                // Network Solutions Certificate Authority
                // https://www.networksolutions.com/website-packages/index.jsp
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x15, 0xf0, 0xba, 0x00, 0xa3, 0xac, 0x7a, 0xf3, 0xac, 0x88, 0x4c,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.782.1.2.1.8.1", ""}
                ...
                // https://www.networksolutions.com/website-packages/index.jsp
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x00, 0x16, 0x86, 0xcd, 0x18, 0x1f, 0x83, 0xa1, 0xb1, 0x21, 0x7d,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.782.1.2.1.8.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x6b, 0x9c, 0x08, 0xe8, 0x6e, 0xb0, 0xf7, 0x67, 0xcf, 0xad, 0x65,
                      0xcd, 0x98, 0xb6, 0x21, 0x49, 0xe5, 0x49, 0x4a, 0x67, 0xf5, 0x84,
                      0x5e, 0x7b, 0xd1, 0xed, 0x01, 0x9f, 0x27, 0xb8, 0x6b, 0xd6},
              PolicyOids = new string [] {"2.16.756.5.14.7.4.8", ""}
            },
                // QuoVadis Root CA 2
                // https://www.quovadis.bm/
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x85, 0xa0, 0xdd, 0x7d, 0xd7, 0x20, 0xad, 0xb7, 0xff, 0x05, 0xf8,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.8024.0.2.100.1.2", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x8f, 0xe4, 0xfb, 0x0a, 0xf9, 0x3a, 0x4d, 0x0d, 0x67, 0xdb, 0x0b,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.8024.0.2.100.1.2", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xf1, 0xc1, 0xb5, 0x0a, 0xe5, 0xa2, 0x0d, 0xd8, 0x03, 0x0e, 0xc9,
              ...
              PolicyOids = new string [] {"2.16.840.1.114404.1.1.2.4.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x42, 0x00, 0xf5, 0x04, 0x3a, 0xc8, 0x59, 0x0e, 0xbb, 0x52, 0x7d,
              ...
              PolicyOids = new string [] {"2.16.840.1.114404.1.1.2.4.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xe7, 0x5e, 0x72, 0xed, 0x9f, 0x56, 0x0e, 0xec, 0x6e, 0xb4, 0x80,
              ...
              PolicyOids = new string [] {"1.2.392.200091.100.721.1", ""}
                ...
                // https://www.secomtrust.net/contact/form.html
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xa2, 0x2d, 0xba, 0x68, 0x1e, 0x97, 0x37, 0x6e, 0x2d, 0x39, 0x7d,
              ...
              PolicyOids = new string [] {"1.2.392.200091.100.721.1", ""}
                ...
                // https://www.secomtrust.net/contact/form.html
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x51, 0x3b, 0x2c, 0xec, 0xb8, 0x10, 0xd4, 0xcd, 0xe5, 0xdd, 0x85,
              ...
              PolicyOids = new string [] {"1.2.392.200091.100.721.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x4d, 0x24, 0x91, 0x41, 0x4c, 0xfe, 0x95, 0x67, 0x46, 0xec, 0x4c,
              ...
              PolicyOids = new string [] {"2.16.528.1.1003.1.2.7", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xc7, 0x66, 0xa9, 0xbe, 0xf2, 0xd4, 0x07, 0x1c, 0x86, 0x3a, 0x31,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.23223.1.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x14, 0x65, 0xfa, 0x20, 0x53, 0x97, 0xb8, 0x76, 0xfa, 0xa6, 0xf0,
              ...
              PolicyOids = new string [] {"2.16.840.1.114414.1.7.23.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x2c, 0xe1, 0xcb, 0x0b, 0xf9, 0xd2, 0xf9, 0xe1, 0x02, 0x99, 0x3f,
              ...
              PolicyOids = new string [] {"2.16.840.1.114414.1.7.23.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x56, 0x8d, 0x69, 0x05, 0xa2, 0xc8, 0x87, 0x08, 0xa4, 0xb3, 0x02,
              ...
              PolicyOids = new string [] {"2.16.840.1.114414.1.7.24.3", "2.23.140.1.1"}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x62, 0xdd, 0x0b, 0xe9, 0xb9, 0xf5, 0x0a, 0x16, 0x3e, 0xa0, 0xf8,
              ...
              PolicyOids = new string [] {"2.16.756.1.89.1.2.1.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xd9, 0x5f, 0xea, 0x3c, 0xa4, 0xee, 0xdc, 0xe7, 0x4c, 0xd7, 0x6e,
              ...
              PolicyOids = new string [] {"2.16.756.1.83.21.0", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xab, 0x70, 0x36, 0x36, 0x5c, 0x71, 0x54, 0xaa, 0x29, 0xc2, 0xc2,
              ...
              PolicyOids = new string [] {"2.16.840.1.113733.1.7.48.1", ""}
                ...
                // https://www.thawte.com/
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x8d, 0x72, 0x2f, 0x81, 0xa9, 0xc1, 0x13, 0xc0, 0x79, 0x1d, 0xf1,
              ...
              PolicyOids = new string [] {"2.16.840.1.113733.1.7.48.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xa4, 0x31, 0x0d, 0x50, 0xaf, 0x18, 0xa6, 0x44, 0x71, 0x90, 0x37,
              ...
              PolicyOids = new string [] {"2.16.840.1.113733.1.7.48.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x4b, 0x03, 0xf4, 0x58, 0x07, 0xad, 0x70, 0xf2, 0x1b, 0xfc, 0x2c,
              ...
              PolicyOids = new string [] {"2.16.840.1.113733.1.7.48.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x59, 0x76, 0x90, 0x07, 0xf7, 0x68, 0x5d, 0x0f, 0xcd, 0x50, 0x87,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.40869.1.1.22.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xbf, 0xd8, 0x8f, 0xe1, 0x10, 0x1c, 0x41, 0xae, 0x3e, 0x80, 0x1b,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.40869.1.1.22.3", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xfd, 0x73, 0xda, 0xd3, 0x1c, 0x64, 0x4f, 0xf1, 0xb4, 0x3b, 0xef,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.7879.13.24.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x4f, 0xf4, 0x60, 0xd5, 0x4b, 0x9c, 0x86, 0xda, 0xbf, 0xbc, 0xfc,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6449.1.2.1.5.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xe7, 0x93, 0xc9, 0xb0, 0x2f, 0xd8, 0xaa, 0x13, 0xe2, 0x1c, 0x31,
              ...
              PolicyOids = new string [] {"1.3.6.1.4.1.6449.1.2.1.5.1", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x6e, 0xa5, 0x47, 0x41, 0xd0, 0x04, 0x66, 0x7e, 0xed, 0x1b, 0x48,
              ...
              PolicyOids = new string [] {
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x58, 0xd0, 0x17, 0x27, 0x9c, 0xd4, 0xdc, 0x63, 0xab, 0xdd, 0xb1,
              ...
              PolicyOids = new string [] {"2.16.840.1.114413.1.7.23.3", "2.16.840.1.114414.1.7.23.3"}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xe7, 0x68, 0x56, 0x34, 0xef, 0xac, 0xf6, 0x9a, 0xce, 0x93, 0x9a,
              ...
              PolicyOids = new string [] {"2.16.840.1.113733.1.7.23.6", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x69, 0xdd, 0xd7, 0xea, 0x90, 0xbb, 0x57, 0xc9, 0x3e, 0x13, 0x5d,
              ...
              PolicyOids = new string [] {"2.16.840.1.113733.1.7.23.6", ""}
                ...
                // https://www.verisign.com/
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x9a, 0xcf, 0xab, 0x7e, 0x43, 0xc8, 0xd8, 0x80, 0xd0, 0x6b, 0x26,
              ...
              PolicyOids = new string [] {"2.16.840.1.113733.1.7.23.6", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0x23, 0x99, 0x56, 0x11, 0x27, 0xa5, 0x71, 0x25, 0xde, 0x8c, 0xef,
              ...
              PolicyOids = new string [] {"2.16.840.1.113733.1.7.23.6", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xa7, 0x12, 0x72, 0xae, 0xaa, 0xa3, 0xcf, 0xe8, 0x72, 0x7f, 0x7f,
              ...
              PolicyOids = new string [] {"2.16.840.1.114171.500.9", ""}
                ...
                new ExtendedValidationMetadata {
             Sha256Fingerprint = new byte[] {0xce, 0xcd, 0xdc, 0x90, 0x50, 0x99, 0xd8, 0xda, 0xdf, 0xc5, 0xb1,
    ...
    {
        public byte[] Sha256Fingerprint { get; set; }
